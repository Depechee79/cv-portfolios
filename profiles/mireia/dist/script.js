...
const translations = {
  "es": {
    ...
    "ref.1.name": "Aitor Xavier Zurutuza del Río",
    "ref.1.role": "Restaurant Manager — Erre Urrechu",
    "ref.1.company": "Hotel Gran Meliá Torre Melina, Barcelona",
    "ref.2.name": "Fabián",
    "ref.2.role": "F&B Manager",
    "ref.2.company": "Hotel Gran Meliá Torre Melina, Barcelona",
    "ref.3.name": "Íñigo Pérez Urrechu",
    "ref.3.role": "Chef & Propietario — Grupo Urrechu",
    "ref.3.company": "Fundador de Restaurantes Urrechu y Zalacaín",
  ...
  "en": {
    ...
    "ref.3.company": "Founder of Restaurantes Urrechu and Zalacaín",
  ...
  "ca": {
    ...
    "edu.3.details": "Educació secundària postobligatòria.",
    "edu.4.date": "SET 2012 - JUL 2016",
    "edu.4.school": "Institut Duc de Montblanc, Barcelona",
    "edu.4.title": "Educació Secundària Obligatòria (ESO)",
    "edu.5.date": "JUN - AGO 2018",
    "edu.5.school": "La Boqueria, Barcelona",
    "edu.5.title": "Curs de Cuina",
    "edu.5.details": "Formació pràctica en tècniques culinàries.",
    ...
    "ref.3.company": "Fundador de Restaurants Urrechu i Zalacaín",
