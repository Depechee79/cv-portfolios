...
const THEMES = {
    ...
    'hospitality-light': {
        accent: '#2D5A3D',
        sidebarAccent: '#8FBF9E',
        sidebarBg: '#1E3D2B',
        sidebarText: '#d0dfd5',
        sidebarTextMuted: '#8aaa92',
        sidebarNameColor: '#FFFFFF',
        sidebarDivider: 'rgba(143,191,158,0.25)',
        skillBg: 'rgba(143,191,158,0.12)',
        skillText: '#8FBF9E',
        qrDark: '#8FBF9E',
        qrLight: '#1E3D2B',
        fontHeading: 'Montserrat',
...
async function generatePDF() {
    ...
    const replacements = {
        ...
        '{{ACCENT}}': theme.accent,
        '{{SIDEBAR_ACCENT}}': theme.sidebarAccent || theme.accent,
